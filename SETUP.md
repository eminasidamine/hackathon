...
2. **SQL Editor** → coller le contenu de `supabase/marketplace_schema.sql` → Run.
   Crée les 12 tables, les fonctions, les triggers, les policies RLS et les
   4 buckets de stockage en une fois.
