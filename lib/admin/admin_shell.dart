          ...
          SizedBox(
            ...
            child: SafeArea(
                child: _SidebarContent(
                    index: _index, onSelect: _select, auth: auth)),
          ),
...
class _SidebarContent extends StatelessWidget {
  ...
  const _SidebarContent(
      {required this.index, required this.onSelect, required this.auth});
          ...
          Padding(
            ...
            child: Row(
              children: [
                const CircleAvatar(
                    radius: 16,
                    backgroundColor: AdminTheme.redTint,
                    child: Icon(Icons.person, size: 16, color: AdminTheme.red)),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon,
                size: 19, color: selected ? AdminTheme.red : AdminTheme.ink2),
