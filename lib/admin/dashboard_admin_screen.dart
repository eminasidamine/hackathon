...
class _DashboardAdminScreenState extends State<DashboardAdminScreen> {
  ...
  Future<_Counts> _load() async {
    ...
    final pendingOrders =
        await _client.from('orders').select('id').eq('status', 'pending');
    ...
    return SizedBox(
      ...
      child: AdminCard(
        ...
        child: Column(
          ...
          children: [
            Icon(icon,
                color: highlight ? AdminTheme.red : AdminTheme.ink2, size: 22),
            ...
            if (sub != null) ...[
              ...
              Text(sub!,
                  style:
                      const TextStyle(fontSize: 11.5, color: AdminTheme.muted)),
            ],
          ],
        ),
      ),
