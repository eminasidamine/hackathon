                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: const TextStyle(
                            fontSize: 11.5, color: AppTheme.muted, height: 1.8),
                      ),
                    ),
                  ),
                ],
        ...
        child: Column(
          ...
          children: [
            for (final entry in const [('en', 'English'), ('fr', 'Français')])
              ListTile(
                title: Text(entry.$2),
                trailing: settings.locale == entry.$1
                    ? const Icon(Icons.check, color: AppTheme.red)
                    : null,
                onTap: () {
...
class _NotLoggedInAccountState extends State<_NotLoggedInAccount> {
  void _comingSoon() {
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text(widget.t('coming_soon'))));
  }
    ...
    return Column(
      children: [
        ...
        _RowGroup(rows: [
          _AccountRow(
              icon: _AccIcon.bell,
              label: t('comm_preferences'),
              onTap: _comingSoon),
          _AccountRow(
              icon: _AccIcon.globe,
              label: t('country_language'),
...
class _Band extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      Container(height: 9, color: AppTheme.panel);
}
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(
                fontSize: 13, color: AppTheme.ink.withValues(alpha: 0.6)),
          ),
        ],
      ),
    );
...
class _AccountRowIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      SvgPicture.string(_svg, width: 19, height: 19);
}
