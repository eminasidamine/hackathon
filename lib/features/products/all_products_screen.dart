...
class AllProductsScreen extends StatefulWidget {
  ...
  const AllProductsScreen(
      {super.key, this.categoryId, this.categoryName, this.search});
      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            _SortTile(
                label: t('sort_newest'), value: 'newest', groupValue: _sort),
            _SortTile(
            ...
            if (_bannerFuture != null)
              FutureBuilder<List<HomeBanner>>(
                ...
                builder: (context, snapshot) {
                  final urls =
                      (snapshot.data ?? []).map((b) => b.imageUrl).toList();
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(label,
                  style: TextStyle(
                      fontSize: 12.5, fontWeight: FontWeight.w500, color: fg)),
              if (badge > 0) ...[
                const SizedBox(width: 6),
                Container(
